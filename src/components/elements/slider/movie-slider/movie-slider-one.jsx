    ...
    <>
      <section className="featured-area section-spacing featured-full-width p-relative bg-common-black">
        <div className="container">
          <div className="row g-5 section-title-spacing wow fadeInUp" data-wow-delay="0.3s">
        ...
        <div className="container section-spacing-bottom">
          <div className="featured-wrapper featured-slider-wrapper wow fadeInUp" data-wow-delay="0.4s">
            <Swiper
