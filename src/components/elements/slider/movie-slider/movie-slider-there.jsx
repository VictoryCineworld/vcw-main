          ...
          <div className="fm-slider-active">
            <div>
              <Swiper
                ...
                a11y={false}
              >
                {movieData.slice(32, 35).map((item) => (
                          ...
                          <div className="col-xl-8 col-lg-8">
                            <div className="fm-landing-slider-content ">
                              <div className="fm-landing-slider-subtext fm-landing-slider-subtext-responsive mb-20 fm-translateY-80 fm-delay-03 fm-opacity-0 fm-duration-07">
                                <span
                                  className="fm-landing-slider-subtag"
                                >
                                  {item.movieTag}
                                </span>
                                <span
                              ...
                              <h2
                                className="fm-landing-slider-title mb-25 fm-translateY-80 fm-delay-04 fm-opacity-0 fm-duration-07"
                              >
                                {item.title}
                              </h2>
                              ...
                              <div className="fm-landing-slider-info mt-30 mb-35 fm-translateY-80 fm-delay-06 fm-opacity-0 fm-duration-07">
                                <span data-animation="fadeInUp" data-delay=".7s">
                                  {item.movieLanguage}
                                </span>
                                <span data-animation="fadeInUp" data-delay=".8s">
                                  {item.adventure}
                                </span>
                                <span data-animation="fadeInUp" data-delay=".9s">
                                  {item.cast}
                                </span>
                              </div>
                              <div
                                className="fm-landing-slider-review fm-translateY-80 fm-delay-07 fm-opacity-0 fm-duration-07"
                              >
                                <i className="fa-solid fa-star"></i> {item.review}
                              </div>
                              <div
                                className="fm-landing-slider-button mt-45 fm-translateY-80 fm-delay-08 fm-opacity-0 fm-duration-07"
                              >
                                <Link
                                  href={`/movie-details/${item.id}`}
                                  className="fm-director-btn is-white arrow-effect"
                                >
                                  {item.movieBtn} <span><i className="fa-light fa-arrow-right-long"></i></span>
                                </Link>
                              </div>
                            </div>
                          </div>
