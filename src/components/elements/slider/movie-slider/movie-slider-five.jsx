            ...
            <div className="fm-landing-genre-slider-wrapper">
              <div className="fm-landing-genre-slider-active">
                <div>
                  ...
                  >
                    {movieData.slice(40, 47).map((item) => (
                      <SwiperSlide key={item.id}>
                        <div className="fm-landing-genre-single wow fadeInUp" data-wow-delay={item.delay}>
                          <Link
                            href="/movie"
                          ...
                          >
                            <Image
                              ...
                              alt="img"
                            />
                            <span className="fm-landing-genre-name">{item.movieTag}</span>
                          </Link>
                          <Link href="/movie" className="fm-landing-genre-namesm">
                            {item.MovieBtn}
                          </Link>
                        </div>
                      </SwiperSlide>
