  ...
  return (
    <>
      ...
      <div className="fm-movie-slider-area fm-movie-pad">
        <div className="fm-movie-slider-wrapper wow fadeInUp" data-wow-delay="0.3s">
          <div className="fm-movie-slider-active">
            <div>
              ...
              >
                {movieData.slice(17, 20).map((item) => (
                  <SwiperSlide key={item.id}>
                    ...
                    >
                      <div className="fm-movie-slider-content">
                        ...
                        <h4 className="fm-movie-slider-title">{item.title}</h4>
                        <span className="fm-movie-duration">
                          {item.duration}
                        </span>
                      </div>
                      <div className="fm-movie-video">
                        <button className="popup-video" onClick={() => { openVideoModal(item.videoUrl) }}>
