   ...
   return (
      <>
         <section className="about-area fm-about-style bg-common-black">
            <div className="fm-about-bg-thumb" style={{ backgroundImage: `url(${aboutBgImg.src})` }}>
                     ...
                     <div className="fm-about-wrapper section-spacing">
                        <div className="section-title">
                           ...
                           <h2 className="section-main-title text-white mb-30 title-anim wow fadeInUp" data-wow-delay="0.4s">On-Demand Video
                              Production
                              Company </h2>
                           <p className="about-text-2 large wow fadeInUp" data-wow-delay="0.5s">We Believe Film And Moving Image Has The Power
                              To
                              Create
                              Significant Change. We Help Brands Realise That Power And Agencies To Bri Ng
                              Their
                              Creative
                              Vision To Fruition.</p>
                        </div>
