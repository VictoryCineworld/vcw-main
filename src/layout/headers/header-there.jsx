...
const HeaderThere = () => {
    ...
    return (
        <>
       <header id="header-sticky" className='fm-header-area header-border transparent-header header-main'>
         ...
         <div className="row align-items-center justify-content-lg-between">
            <div className="header-wrapper">
               <div className="fm-header-logo-wrapper">
                  ...
                  <button onClick={() => setIsOffCanvasOpen(true)} className="fm-header-bar-1">
