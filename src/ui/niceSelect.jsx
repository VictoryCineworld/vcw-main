...
const NiceSelect = ({options,defaultCurrent, placeholder,className,onChange,name,setCategorys}) => {
    ...
    return (
        <div
            ...
            ref={ref}
        >
            <span className="current">{current?.category || placeholder}</span>
            <ul
                className="list"
                role="menubar"
