import { data } from "@data/services/video-production/product-shoot-data";
    ...
    <>
      ...
      <main>
        ...
        <section className="case-details-area">
          <>
            <div
              className="case-slider-area section-spacing wow fadeInUp"
              data-wow-delay="0.3s"
            >
          ...
          <div className="service-area section-spacing-bottom">
              ...
              content={
                <>
                  <p className="mb-55 ">
                    ...
                    maintenance, and manual inspections can limit the ability to
                    report and verify current conditions. The choice of font and
                    font size with which Lorem ipsum is reproduced answers to
                    specific needs that go beyond the simple and simple filling
                    of spaces dedicated to accepting real texts and allowing to
                    have hands an advertising/publishing product, both web and
                    paper, true to reality.
                  </p>
                  <p className="">
                    {" "}
                    One of the main objectives for the new site was to attract
                    new business and leave a memorable impression on (often
                    busy) brand representatives and ad agencies. Secondary
                    objective was to present Ali’s story in an immersive way in
                    order to connect with his audience and express his love for
          ...
          <section className="step-area section-spacing-bottom">
            <div className="container">
              <div
              ...
              <div
                className="step-main-wrapper wow fadeInUp"
                data-wow-delay="0.4s"
              >
                <div className="row g-5">
                  {steps.map((item) => (
                    <div
                      className="col-xxl-6 col-xl-3 col-lg-4 col-md-6 col-sm-6"
                      key={item.id}
                    >
